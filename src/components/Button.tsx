  ...
  return (
    <div className="buttons-container">
      ...
      <div className="button-row">
        <button className="top" onClick={onPress}>
          C
        </button>
        <button className="top" onClick={onPress}>
          +/-
        ...
        <button className="last-button" onClick={onPress}>
          ÷
        </button>
      </div>
      <div className="button-row">
      ...
      <div className="button-row">
        <button className="zero-btn" onClick={onPress}>
          0
        </button>
        <button className="decimal-btn" onClick={onPress}>
          .
        </button>
        <button className="last-button equal-sign-btn" onClick={onPress}>
          =
        </button>
      </div>
    </div>
